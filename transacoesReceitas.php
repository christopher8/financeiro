<?php 
 if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['lista'])){
    include_once('listaReceitas.php');
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['receitas'])) {
...
<div class="form-container">
    ...
    <input type="hidden" name="receitas" value="1">
    
    
    

        <div class="form-group">
            <label for="id_conta_origem">Conta :</label>
        ...
        <div class="form-group" id="descricao_manual_field">
            <label for="descricao_manual">Origem :</label>
